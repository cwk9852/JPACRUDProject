...
CREATE TABLE `inventorydb`.`tea` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  `description` VARCHAR(450) NULL,
  `price` DECIMAL(6,2) NULL,
  `qty` INT(11) NULL,
  `img` VARCHAR(4500) NULL,
  `category_id` INT(11) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_tea_category_id_idx` (`category_id` ASC),
  CONSTRAINT `fk_tea_category_id`
